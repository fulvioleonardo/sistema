...
class TenantDocumentPosPayments extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('documents_pos_payments', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('documents_pos_payments');
